...
\includegraphics[scale=\schscale]{../fig/dc-motor-serie-plot1.pdf}
...
\[ \frac{U_2}{U_1} = \frac{N_2}{N_1} = \frac{1}{ü} = \frac{I_1}{I_2}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=\schscale]{../fig/trafo-t-ersatz.pdf}
